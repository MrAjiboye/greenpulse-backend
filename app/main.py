...
from app.routers import admin, auth, billing, carbon, dashboard, demo, energy, goals, insights, notifications, reports, team, waste, oauth, ml, ingest, octopus, n3rgy
...
app.include_router(n3rgy.router,     prefix=API_V1)
